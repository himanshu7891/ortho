...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.orthoChat.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ortho-chats.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ortho_chat_access') ? 'is-invalid' : '' }}" type="text" name="ortho_chat_access" id="ortho_chat_access" value="{{ old('ortho_chat_access', '') }}">
