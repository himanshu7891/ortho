        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('locations') ? 'is-invalid' : '' }}" name="locations[]" id="locations" multiple required>
                    @foreach($locations as $id => $location)
                        <option value="{{ $id }}" {{ (in_array($id, old('locations', [])) || $user->locations->contains($id)) ? 'selected' : '' }}>{{ $location }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check ">
                    ...
                    <input class="form-check-input" type="checkbox" name="notify_email" id="notify_email" value="1" @if(is_array(old('notify_email')) && in_array(1, old('notify_email')) || $user->notify_email == '1') checked @endif>
            ...
            <div class="form-group">
                <div class="form-check ">
                    ...
                    <input class="form-check-input" type="checkbox" name="notify_sms" id="notify_sms" value="1" @if(is_array(old('notify_sms')) && in_array(1, old('notify_sms')) || $user->notify_sms == '1') checked @endif>
            ...
            <div class="form-group">
                <div class="form-check ">
                    ...
                    <input class="form-check-input" type="checkbox" name="notify_voice" id="notify_voice" value="1"  @if(is_array(old('notify_voice')) && in_array(1, old('notify_voice')) || $user->notify_voice == '1') checked @endif>
            ...
            <div class="form-group">
                <div class="form-check ">
                    ...
                    <input class="form-check-input" type="checkbox" name="new_patient" id="new_patient" value="1"  @if(is_array(old('new_patient')) && in_array(1, old('new_patient')) || $user->new_patient == '1') checked @endif>
