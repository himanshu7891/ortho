    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.locations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax_number') ? 'is-invalid' : '' }}" type="text" name="fax_number" id="fax_number" value="{{ old('fax_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('accept_emergencies') ? 'is-invalid' : '' }}" name="accept_emergencies" id="accept_emergencies" required>
                    ...
                    @foreach(App\Models\Location::ACCEPT_EMERGENCIES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('accept_emergencies', 'NULL') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('coming_soon') ? 'is-invalid' : '' }}" name="coming_soon" id="coming_soon" required>
                    ...
                    @foreach(App\Models\Location::COMING_SOON_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('coming_soon', 'NULL') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('active') ? 'is-invalid' : '' }}" name="active" id="active" required>
                    ...
                    @foreach(App\Models\Location::ACTIVE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('active', 'NULL') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('directions') ? 'is-invalid' : '' }}" type="text" name="directions" id="directions" value="{{ old('directions', '') }}">
