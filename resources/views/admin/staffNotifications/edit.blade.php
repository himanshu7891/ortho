    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.staff-notifications.update", [$staffNotification->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_name') ? 'is-invalid' : '' }}" type="text" name="location_name" id="location_name" value="{{ old('location_name', $staffNotification->location_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $staffNotification->first_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $staffNotification->last_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_address') ? 'is-invalid' : '' }}" type="text" name="email_address" id="email_address" value="{{ old('email_address', $staffNotification->email_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $staffNotification->phone_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notify_sms') ? 'is-invalid' : '' }}" type="text" name="notify_sms" id="notify_sms" value="{{ old('notify_sms', $staffNotification->notify_sms) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notify_voice') ? 'is-invalid' : '' }}" type="text" name="notify_voice" id="notify_voice" value="{{ old('notify_voice', $staffNotification->notify_voice) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notify_email') ? 'is-invalid' : '' }}" type="text" name="notify_email" id="notify_email" value="{{ old('notify_email', $staffNotification->notify_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notify_new_patient') ? 'is-invalid' : '' }}" type="text" name="notify_new_patient" id="notify_new_patient" value="{{ old('notify_new_patient', $staffNotification->notify_new_patient) }}">
